        ...
        <section className="py-12 bg-white border-b border-gray-100">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <AnimatedSection direction="up">
              <div className="text-center">
                <a
                  href="https://www.google.com/search?q=kimshospitals+kodapur&oq=kimshospitals+kodapur&gs_lcrp=EgZjaHJvbWUyBggAEEUYOTIPCAEQLhgNGK8BGMcBGIAEMgoIAhAAGKIEGIkFMgcIAxAAGO8FMgoIBBAAGIAEGKIEMgcIBRAAGO8FMgcIBhAAGO8F0gEJMTIzNDlqMGo3qAIAsAIA&sourceid=chrome&source=chrome.ob&ie=UTF-8#lrd=0x3bcb93239ade09c7:0x85d06a664cd40d56,1,,,,&topic=mid:QT5grHZGlc8"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-3 rounded-xl bg-white border-2 border-[#d32537] px-6 py-4 text-[#d32537] hover:bg-[#d32537] hover:text-white transition-all duration-300 group shadow-sm hover:shadow-md hover:-translate-y-0.5"
                >
                ...
                </a>                  <p className="mt-3 text-xs text-gray-400">
                    See what others are saying about their experience with Dr. Nisarga on Google.
                  </p>
              </div>
            </AnimatedSection>
          </div>
          ...
          <div className="mx-auto max-w-3xl px-6 lg:px-8 text-center">
            <AnimatedSection direction="up">
              ...
              <div className="mt-8 flex flex-wrap justify-center gap-4">                    <Link
                  ...
                  className="flex items-center gap-2 rounded-lg bg-white px-6 py-3.5 text-base font-semibold text-[#d32537] shadow-lg transition-all hover:bg-red-50 hover:-translate-y-0.5"
                >
                  Book an Appointment
                </Link>
                <Link
                  href="/services"
                  className="flex items-center gap-2 rounded-lg border-2 border-white/40 px-6 py-3.5 text-base font-semibold text-white transition-all hover:border-[#d32537] hover:text-[#d32537] hover:bg-white/10 hover:-translate-y-0.5"
                >
                  Explore Services
                </Link>
              </div>
